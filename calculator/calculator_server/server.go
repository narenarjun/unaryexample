...
func (*server) SquareRoot(ctx context.Context, req *calculatorpbgen.SquareRootRequest) (*calculatorpbgen.SquareRootResponse, error){
	fmt.Println("Receiverd SquareRoot RPC ")
	...
	return &calculatorpbgen.SquareRootResponse{
